class OeisTui < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/hako/oeis-tui/releases/download/v#{version}/oeis-x86_64-apple-darwin.tar.gz"
      sha256 "f9ce615c883872c3db71b3a7c509b902ea9b7866d135579cdb1b9b097e64b351"
    end

    on_arm do
      url "https://github.com/hako/oeis-tui/releases/download/v#{version}/oeis-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/hako/oeis-tui/releases/download/v#{version}/oeis-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "fdd05624601714cfcf5c1edae40b415668a6b69e9d6df5ebd31648621676c6d8"
    end

    on_arm do
      url "https://github.com/hako/oeis-tui/releases/download/v#{version}/oeis-aarch64-unknown-linux-gnu.tar.gz"
